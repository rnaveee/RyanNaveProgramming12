...
public class LifeGameFrame extends javax.swing.JFrame 
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(buttonSave, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
    ...
    public boolean isAlive(int c, int r) {
        ...
        if ( (c<0) || (r<0) || (c>=gridCount) || (r>=gridCount) )
            return(false);
        if (grid[c][r]==0)
            return(false);
        //must be 1...
    ...
    public void step() {
        //empty now
        //sample code... randomly pick a spot to turn white
    ...
    public void actionPerformed(ActionEvent e) {
        //should check to see if it is the Timer calling this...
