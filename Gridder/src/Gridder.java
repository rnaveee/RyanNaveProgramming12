...
public class Gridder extends javax.swing.JFrame 
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        int[][] temp = new int[gridCount][gridCount];
        for (int r=0; r < gridCount; r++){
            for (int c=0; c < gridCount; c++){
                temp[r][c] = grid[r][c];
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int[][] tempTwo = new int[gridCount][gridCount];
        for (int r = 0; r < gridCount; r++) {
            for (int c = 0; c < gridCount; c++) {
                if(grid[r][c] == 1){
                    tempTwo[c][r] = grid[r][c];
                }
        ...
        for (int r = 0; r < gridCount; r++) {
            for (int c = 0; c < gridCount; c++) {
                temp[r][c] = tempTwo[gridCount-r-1][c];
            }
        }
